    ...
    return (
      <div className="group bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-blue-200 overflow-hidden w-full">
        ...
        <div className="p-4 text-center">
          <h3 className="text-lg font-semibold text-blue-900 group-hover:text-blue-700 transition-colors mb-1">{member.name}</h3>
          <div className="w-12 h-0.5 bg-blue-500 rounded-full mb-2 mx-auto"></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {teamMembers.map((member, index) => (
              <div key={index} className="transform hover:-translate-y-1 transition-transform duration-300 w-64">
                <TeamMemberCard member={member} />
              </div>
            ))}
          </div>
